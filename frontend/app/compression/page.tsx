import FraCompression from '@/components/FraCompression';
      ...
      <header className="border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <nav className="flex gap-6">
            <a href="/" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">EDIFACT Processor</a>
            <a href="/compression" className="text-blue-600 dark:text-blue-400 font-medium">.fra Compression</a>
